...
public class PSAAdapter extends ArrayAdapter<DBPSAView>{
    ...
    public PSAAdapter(Context context, ArrayList<DBPSAView> psa){
        super (context, R.layout.psa_layout, R.id.AuthorName, psa);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        viewHolder.AuthorName.setText(psa.getAuthor());
        viewHolder.Date.setText(psa.getTimestamp());
